    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2 text-sm">Join Horizon and start planning your future</p>
        </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl py-3 pl-11 pr-4 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all"
                />
              </div>
            </div>
